...
Revision ID: f06c762665ce
Revises: a5cffa318ac2
Create Date: 2026-03-03 19:28:01.431509
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('type', sa.Enum('image', 'video', 'carousel', name='mediatype'), nullable=False),
